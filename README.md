...
This repository contains project programs that were completed for the low-level programming track at ALX Holberton Software Engineering Programme. In these projects, I learnt data structures, algorithms, and other concepts while working in the C language. The projects are listed as follows:
...
* __Mkhuseli Faku__ <[fakugmkhuseli](https://github.com/fakugmkhuseli)>
